...
venue: "Berlin Institute for Medical Systems Biology"        # brief name of host site without address (e.g., "Euphoric State University")
address: "MDC, Berlin Buch"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "52.628184,13.506572"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "March 14th, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "1pm to 5pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-03-14      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-03-14        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Rob Beagrie"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: []     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["rob@beagrie.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
